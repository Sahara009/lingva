  ...
  const items = [
    {
      ...
      title: "Студентам",
      text: "Подходит для тех, кто хочет изучать языки с нуля или улучшить свой уровень в удобном формате.",
      color: "var(--pastel-blue)",
    },
    {
      icon: <Globe2 />,
      title: "Путешественникам",
      text: "Идеально для людей, увлечённых культурой Востока и мечтающих о стажировках за рубежом.",
